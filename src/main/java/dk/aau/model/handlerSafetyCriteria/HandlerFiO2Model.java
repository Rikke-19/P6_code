...
public class HandlerFiO2Model implements Queryable {
    ...
    public String returnSqlQuery() {
        String sqlStatement = "SELECT SafetyCriteria, Value, Timestamp FROM Result WHERE SafetyCriteria = 'FiO2' AND Timestamp = (SELECT MAX(Timestamp) FROM Result WHERE SafetyCriteria = 'FiO2' AND Timestamp BETWEEN "+"'"+App.previousDate+"' AND '"+ App.currentDate+"')";// AND CPRnumber="+Patient.getCprNummer();
        return sqlStatement;
    }
}*/